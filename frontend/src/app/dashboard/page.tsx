                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden md:flex items-center gap-3 px-4 py-2 rounded-2xl bg-white/30 dark:bg-slate-800/30 border border-white/20 dark:border-slate-700/50 backdrop-blur-sm shadow-sm ring-1 ring-white/10">
                            ...
                            <div className="flex flex-col">
                                <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">Hoş geldin,</span>
            ...
            <main className="relative z-10 w-full px-[50px] py-12">
                ...
                <div className="mb-14 flex justify-center">
                    <div className="flex items-center text-start gap-4">
                        ...
                        <div>
                            <h3 className="text-3xl mb-0 font-extralight text-indigo-600 dark:text-indigo-400 tracking-[0.2em] leading-none uppercase" id="title">Yönetim Paneli</h3>
                            <h5 className="text-slate-400 dark:text-slate-500 text-lg font-medium mt-0.5">İşletmenizin tüm kontrolü burada.</h5>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px]">
                    ...
                    <DashboardCard
                        ...
                        description="Sipariş ve masa adisyon yönetimi"
                    ...
                    <DashboardCard
                        title="Envanter & Stok"
                        description="Ürün reçeteleri ve depo takibi"
                    ...
                    <DashboardCard
                        title="Paket Servis"
                        description="Teslimat, kurye ve rota yönetimi"
                        icon="fa-truck-fast"
                    ...
                    <DashboardCard
                        title="Hesaplar"
                        description="Fatura, tahsilat ve bilanço kasaları"
                        icon="fa-coins"
                    ...
                    <DashboardCard
                        title="Garson Paneli"
                        description="El terminalleri sipariş arayüzü"
                    ...
                    <DashboardCard
                        title="Mutfak (KDS)"
                        description="Sipariş hazırlık ve bildirim ekranı"
                        icon="fa-utensils"
                    ...
                    <DashboardCard
                        ...
                        description="Satış grafikleri ve istatistikler"
                        icon="fa-chart-mixed"
                    ...
                    <DashboardCard
                        title="Ayarlar"
                        description="Sistem ve kullanıcı tanımlamaları"
                        icon="fa-gears"
        ...
        >
            ...
            <div className="flex relative z-10 w-full h-full">
                <div className="space-y-4">
                    <div className={`w-14 h-14 rounded-2xl bg-gradient-to-tr ${color} flex items-center justify-center text-white shadow-xl shadow-${bg.split('-')[1]}-500/30 transform group-hover:scale-110 transition-transform duration-500`}>
