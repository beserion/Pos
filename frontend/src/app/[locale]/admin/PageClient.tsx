...
export function PageClient() {
    ...
    const sections = [
        ...
        { title: tAdmin('modifiers'), subtitle: tAdmin('modifiersDesc'), path: `/${locale}/admin/modifiers`, icon: 'fa-tags', color: 'text-amber-500' },
        ...
        { title: tAdmin('salesManagement'), subtitle: tAdmin('salesManagementDesc'), path: `/${locale}/admin/sales`, icon: 'fa-basket-shopping', color: 'text-orange-500' },
        { title: tAdmin('purchaseOrders'), subtitle: tAdmin('purchaseOrdersDesc'), path: `/${locale}/admin/orders`, icon: 'fa-cart-shopping', color: 'text-amber-500' },
        { title: tAdmin('companyAccounts'), subtitle: tAdmin('companyAccountsDesc'), path: `/${locale}/finance/accounts`, icon: 'fa-building-columns', color: 'text-blue-500' },
        { title: tAdmin('cari'), subtitle: tAdmin('cariDesc'), path: `/${locale}/cari`, icon: 'fa-users-between-lines', color: 'text-indigo-500' },
                ...
                <div className="flex flex-col items-center mb-16 px-4 relative">
                    ...
                    <div className="flex items-center text-start gap-4 max-w-4xl mx-auto">
                        ...
                        <div className="relative inline-block pb-1">
                            ...
                            <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-indigo-500 to-transparent rounded-full opacity-100"></div>
                            <h5 className="text-muted mb-0 text-lg font-medium text-slate-400 dark:text-slate-500 mt-0.5 leading-tight">{tAdmin('subtitle')}</h5>
                        </div>
                    </div>
                </div>
