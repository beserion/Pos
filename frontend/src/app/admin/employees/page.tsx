    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (formData.id === 0) {
                ...
                toastSwal({ title: 'Başarılı!', text: 'Çalışan eklendi.', icon: 'success' });
            } else {
            ...
            showSwal({ title: 'Hata', text: error?.response?.data?.message || 'Çalışan kaydedilemedi.', icon: 'error' });
        }
    };
            ...
            <div className="w-full px-[50px] py-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h3 className="mb-0 text-3xl font-extralight text-emerald-600 dark:text-emerald-400 leading-none uppercase tracking-[0.25em]">Çalışan Yönetimi</h3>
                            <h5 className="text-muted mb-0 text-lg font-medium text-slate-400 dark:text-slate-500 mt-0.5">Personel listesi, roller ve şube atamalarını yönetin.</h5>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-[40px] w-full max-w-xl shadow-lg overflow-hidden border border-white/20 dark:border-slate-700/50 animate-in fade-in zoom-in duration-300">
                        <div className="p-8 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/20">
                            <div>
                                ...
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Gerekli tüm bilgileri eksiksiz doldurun</p>
                            </div>
