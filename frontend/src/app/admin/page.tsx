...
export default function AdminPage() {
    ...
    const sections = [
        { title: 'Şube Yönetimi', subtitle: 'Şubeleri ekle, düzenle', path: '/admin/locations', icon: 'fa-location-dot', color: 'text-blue-500' },
        { title: 'Bölüm Yönetimi', subtitle: 'Salon, bahçe vb. alanlar', path: '/admin/zones', icon: 'fa-map-location-dot', color: 'text-indigo-500' },
        ...
        { title: 'Kurye Yönetimi', subtitle: 'Kurye atama ve takibi', path: '/admin/couriers', icon: 'fa-user-helmet-safety', color: 'text-orange-500' },
        { title: 'Sipariş Yönetimi', subtitle: 'Tüm sipariş detayları', path: '/admin/orders', icon: 'fa-bowl-food', color: 'text-rose-500' },
        { title: 'Kullanıcı & Yetki', subtitle: 'Giriş ve rol tanımlamaları', path: '/admin/users', icon: 'fa-user-shield', color: 'text-cyan-500' }
    ];
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 font-sans transition-colors duration-300 relative overflow-y-auto">
            ...
            <div className="w-[90%] mx-auto px-6 py-12 relative z-10">
                ...
                <div className="flex flex-col items-center mb-16 px-4 relative">
                    ...
                    >
                        <i className="fat fa-arrow-left group-hover:-translate-x-1 transition-transform"></i>
                        Geri Dön
                    </button>
                    ...
                    <div className="flex items-center text-start gap-4 max-w-4xl mx-auto">
                        ...
                        <div>
                            <h3 className="mb-0 text-3xl font-extralight text-indigo-600 dark:text-indigo-400 tracking-[0.2em] leading-none uppercase" id="title">Sistem Tanımlamaları</h3>
                            <h5 className="text-muted mb-0 text-lg font-medium text-slate-400 dark:text-slate-500 mt-0.5 leading-relaxed">Ana veritabanı kurulum ve yapılandırma işlemlerini merkezi olarak yönetin.</h5>
                        </div>
                    </div>
                </div>
