...
export class ReservationsService {
    ...
    async create(reservationData: any): Promise<Reservation> {
        ...
        const newReservation = this.reservationRepository.create({
            ...
            location: reservationData.locationId ? { id: reservationData.locationId } : null
        });
    ...
    async update(id: number, updateData: any): Promise<Reservation> {
        ...
        } else if (updateData.status === 'CONFIRMED' && (updateData.tableId || updateData.table?.id)) {
        ...
        const updatedReservation = {
            ...reservation,
            ...updateData,
            table: updateData.tableId ? { id: updateData.tableId } : (updateData.table || reservation.table),
            location: updateData.locationId ? { id: updateData.locationId } : (updateData.location || reservation.location)
        };

        return await this.reservationRepository.save(updatedReservation as any);
    }
