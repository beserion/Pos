...
export class EmployeesController {
    ...
    @Patch(':id')
    partialUpdate(@Param('id') id: string, @Body() updateData: Partial<Employee>) {
        return this.employeesService.update(+id, updateData);
    }
    ...
    @Post(':id/documents')
    addDocument(@Param('id') id: string, @Body() body: { documentType: string, documentData: string }) {
        return this.employeesService.addDocument(+id, body.documentType, body.documentData);
    }
