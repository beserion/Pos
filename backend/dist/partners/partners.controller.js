...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all partners, optionally filtered by type (CUSTOMER or SUPPLIER)' }),
    (0, swagger_1.ApiQuery)({ name: 'type', required: false, description: 'Filter by partner type (CUSTOMER or SUPPLIER)' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a specific partner by ID' }),
